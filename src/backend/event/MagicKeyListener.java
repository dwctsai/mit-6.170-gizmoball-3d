 ...
 *          Spring 2001
 * @author: Ragu Vijaykumar (ragu@mit.edu)
 * 			// No longer uses deprecated methods
 *
 * Version: $Id: MagicKeyListener.java,v 1.2 2003/05/13 22:10:56 dwtsai Exp $
 *
 ***************************************************************************/
  ...
  implements KeyListener
{
   ...
   **/
  private static Object marker(KeyEvent e)
  {
   ...
   **/
  private static KeyEvent eventFromMarker(Object marker, KeyEvent e)
  {
    Component source = e.getComponent();
    int id = e.getID();
    long when = e.getWhen();
    int modifiers = e.getModifiers();
    int keyCode = ((Integer) marker).intValue();
